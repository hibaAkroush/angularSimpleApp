...
'use strict';
function classifiedCtrl ($scope, $http, $mdSidenav){
...
$scope.classifieds = [{
    ...
    "image": "https://i.imgur.com/SrQYwjG.jpg",
    "views":213
  },
  {
    "id":"2",
  ...
  },
  {
    ...
    "image":"https://i.imgur.com/bBeouSs.gif",
    "views":77
  },
  {
    "id":"5",
  ...
  classifiedCtrl.$inject=['$scope','$http', '$mdSidenav'];

  return classifiedCtrl;
